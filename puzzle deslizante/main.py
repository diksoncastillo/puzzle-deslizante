...
class Game:
    ...
    def get_high_scores(self):
        with open("mejor_puntuacion.txt", "r") as file:
            scores = file.read().splitlines()
        return scores

    def save_score(self):
        with open("mejor_puntuacion.txt", "w") as file:
            file.write(str("%.3f\n" % self.high_score))
    ...
    def new(self):
        ...
        self.start_game = False
        self.buttons_list = []
        self.buttons_list.append(Button(500, 100, 200, 50, "Revolver", WHITE, BLACK))
    ...
    def draw(self):
        ...
        UIElement(430, 300, "Mejor Puntuacion- %.3f" % (self.high_score if self.high_score > 0 else 0)).draw(self.screen)
        pygame.display.flip()
